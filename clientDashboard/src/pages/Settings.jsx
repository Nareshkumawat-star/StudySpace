...
export default function Settings() {
  ...
  const tabs = [
    { id: 'library', label: 'Library Settings', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500">Manage your library and account settings</p>
      </div>
      ...
      {activeTab === 'library' && (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          <h3 className="font-semibold text-slate-900 mb-6">Library Information</h3>
          ...
          <div className="space-y-6 max-w-2xl">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleLibrarySettingsChange('name', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleLibrarySettingsChange('address', e.target.value)}
                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleLibrarySettingsChange('opening_time', e.target.value)}
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleLibrarySettingsChange('closing_time', e.target.value)}
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleLibrarySettingsChange('radius_meters', e.target.value)}
                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                min="10"
                max="5000"
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => handleLibrarySettingsChange('description', e.target.value)}
                rows={4}
      ...
      {activeTab === 'account' && (
        <div className="space-y-6">
          {/* Account Info */}
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            <h3 className="font-semibold text-slate-900 mb-6">Account Information</h3>
            
            <div className="flex items-start gap-6">
              <div className="w-16 h-16 rounded-2xl bg-primary-100 flex items-center justify-center">
                <span className="text-2xl font-bold text-primary-700">{client?.name?.[0] || 'U'}</span>
              </div>
              <div className="space-y-4 flex-1">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-900">{client?.username}</p>
                </div>
                {client?.email && (
                  <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-red-200 p-6">
            ...
            <p className="text-sm text-slate-600 mb-4">
              Contact your administrator to delete your account or transfer library ownership.
            </p>
          </div>
        </div>
      )}
