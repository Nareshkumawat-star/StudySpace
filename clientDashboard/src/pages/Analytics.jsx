...
export default function Analytics() {
  ...
  const fetchAnalytics = async () => {
    ...
    try {
      ...
      if (seats) {
        ...
        setOccupancyData({ occupied, available, reserved, total: seats.length })
      }
    } catch (error) {
  ...
  const occupancyChartData = {
    ...
    datasets: [
      {
        data: [occupancyData.occupied || 0, occupancyData.available || 0, occupancyData.reserved || 0],
    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500">Track your library's performance and usage patterns</p>
        </div>
        <select
          value={dateRange}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          ...
          <p className="text-3xl font-bold text-slate-900">
            {bookingsData.values?.length > 0 
              ? Math.round(bookingsData.values.reduce((a, b) => a + b, 0) / bookingsData.values.length) 
              : 0}
          </p>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          ...
          <p className="text-xs text-slate-400 mt-1">{occupancyData.occupied} of {occupancyData.total} seats</p>
        </div>
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        {/* Current Occupancy */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          <h3 className="font-semibold text-slate-900 mb-4">Current Seat Distribution</h3>
        ...
        {/* Department Breakdown */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          <h3 className="font-semibold text-slate-900 mb-4">Bookings by Department</h3>
          <div className="h-64">
            <Bar 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700">
                  {bookingsData.values?.length >= 2 
                    ? bookingsData.values[bookingsData.values.length - 1] > bookingsData.values[0]
                      ? 'Increasing'
                      : 'Decreasing'
                    : 'Not enough data'}
                </p>
          ...
          <div className="p-4 bg-green-50 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-green-900">Available Now</p>
                <p className="text-xs text-green-700">{occupancyData.available || 0} seats ready</p>
              </div>
            </div>
          </div>
