        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.statsContainer}>
                <View style={[styles.statCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                    ...
                    <Text style={[styles.statValue, { color: colors.text }]}>{libraryTotals.totalFloors}</Text>
                    <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Floors</Text>
                </View>
                <View style={[styles.statCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                    <MaterialIcons name="meeting-room" size={24} color="#2563eb" />
                    <Text style={[styles.statValue, { color: colors.text }]}>{libraryTotals.totalRooms}</Text>
                    <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Rooms</Text>
                </View>
                <View style={[styles.statCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                    <MaterialIcons name="event-seat" size={24} color="#16a34a" />
                    <Text style={[styles.statValue, { color: colors.text }]}>{libraryTotals.totalSeats}</Text>
                    <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Seats</Text>
                </View>
            </View>
                ...
                {floors.length === 0 ? (
                    <View style={styles.emptyState}>
                        ...
                        <Text style={[styles.emptySubtitle, { color: colors.textSecondary }]}>
                            The library owner can set up floors, rooms, and seats through their dashboard.
                        </Text>
                    </View>
                ) : (
                    floors.map((floor) => {
                        ...
                        return (
                            <View 
                                key={floor.id} 
                                style={[styles.floorCard, { backgroundColor: colors.surface, borderColor: colors.border }]}
                            >
                                {/* Floor Header */}
                                <TouchableOpacity 
                                    ...
                                    activeOpacity={0.7}
                                >
                                    <View style={[styles.floorIcon, { backgroundColor: colors.primaryLight }]}>
                                        <MaterialIcons name="layers" size={24} color={colors.primary} />
                                    </View>
                                    ...
                                    <View style={styles.roomsContainer}>
                                        {rooms.length === 0 ? (
                                            <View style={styles.noRooms}>
                                                <Text style={[styles.noRoomsText, { color: colors.textMuted }]}>
                                            ...
                                            rooms.map((room) => {
                                                ...
                                                return (
                                                    <View 
                                                        key={room.id} 
                                                        style={[styles.roomCard, { backgroundColor: colors.background, borderColor: colors.border }]}
                                                    >
                                                        <View style={styles.roomInfo}>
                                                            <View style={styles.roomHeader}>
                                                                ...
                                                                {room.room_code && (
                                                                    <View style={[styles.roomCodeBadge, { backgroundColor: colors.primaryLight }]}>
                                                            ...
                                                            <View style={styles.roomMeta}>
                                                                <View style={[styles.typeBadge, { backgroundColor: '#dbeafe' }]}>
                                                                    <Text style={styles.typeText}>{room.room_type || 'Study Hall'}</Text>
                                                                </View>
                                                            </View>
                                                            ...
                                                            <View style={styles.seatStats}>
                                                                <View style={styles.seatStatItem}>
                                                                    ...
                                                                    <Text style={[styles.seatStatText, { color: colors.textSecondary }]}>
